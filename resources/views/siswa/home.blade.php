    ...
    <div class="container mt-0">
        <div class="row">
            <div class="col-12 content-library">
                ...
                {{-- @include('components.announcement', ['announcement' => 'Ini adalah pengumuman penting untuk pengguna.']) --}}
                <div>
                    <form action="" method="get">
                        <div class="search create-std">
                            ...
                            <div class="create-students-container">
                                <button><i class="fa-solid fa-plus icon"></i><a href="/students/create">Tambah data
                                        siswa</a></button>
                            </div>
                        </div>
                    </form>
                    ...
                    <tbody>
                        @forelse ($students as $data)
                            <tr>
                                ...
                                <td>{{ $data->nama }}</td>
                                <td>{{ $data->alamat }}</td>
                                <td>{{ $data->jenis_kelamin == 'P' ? 'Perempuan' : 'Laki_laki' }}</td>
                                <td>{{ $data->class->nama }}</td>
                                <td class="action-container d-flex align-middle">
                                    <button class="btn-update">
                                        <i class="fa-solid fa-pen-to-square"></i>
                                        <a href="/students-edit/{{ $data->id }}">Update</a>
                                    </button>
